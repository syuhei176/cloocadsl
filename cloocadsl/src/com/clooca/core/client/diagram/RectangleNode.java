...
public abstract class RectangleNode implements Node {
	...
	public RectangleNode(boolean round) {
	...
	/*{
		return new RectangleNode(bound.x, bound.y, bound.width, bound.height);
	}
	 */
