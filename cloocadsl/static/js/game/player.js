...
Player.prototype.action_go = function() {
	console.log('id:'+this.id+',action:go');
	this.motor_r_pwr = 8;
	this.motor_l_pwr = 8;
}

Player.prototype.action_right = function() {
	console.log('id:'+this.id+',action:right');
	this.motor_r_pwr = 0;
	this.motor_l_pwr = 5;
}

Player.prototype.action_left = function() {
